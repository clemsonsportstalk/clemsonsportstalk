...
<input type="hidden" name="encrypted" value="-----BEGIN PKCS7----------END PKCS7-----
">
...
<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="W2B5XSHHH48LW">
<table>
<tr><td><input type="hidden" name="on0" value="Sizes">On The Prowl Shirt Sizes</td></tr><tr><td><select name="os0">
...
<table>
<tr><td><input type="hidden" name="on0" value="Sizes">Rock Solid Shirt Sizes</td></tr><tr><td><select name="os0">
	<option value="Youth- Small">Youth- Small$15.00 USD</option>
	<option value="Youth- Medium">Youth- Medium$15.00 USD</option>
	<option value="Youth- Large">Youth- Large$15.00 USD</option>
	<option value="Adult- Small">Adult- Small$15.00 USD</option>
...
<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="27XV4JLZ2ZPPN">
<table>
<tr><td><input type="hidden" name="on0" value="Sizes">1-1-1982 Shirt Sizes</td></tr><tr><td><select name="os0">
	<option value="Youth- Small">Youth- Small$15.00 USD</option>
	<option value="Youth- Medium">Youth- Medium$15.00 USD</option>
	<option value="Youth- Large">Youth- Large$15.00 USD</option>
	<option value="Adult- Small">Adult- Small$15.00 USD</option>
...
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="X8RFSPPK3GPNJ">
<table>
<tr><td><input type="hidden" name="on0" value="Sizes">Pitchfork Returns Sizes</td></tr><tr><td><select name="os0">
	<option value="Youth- Small">Youth- Small$15.00 USD</option>
	<option value="Youth- Medium">Youth- Medium$15.00 USD</option>
	<option value="Youth- Large">Youth- Large$15.00 USD</option>
	<option value="Adult- Small">Adult- Small$15.00 USD</option>
