<ul class='nav'>
	...
	<li class='<? if($active) { ?>active<? } ?>'>
		<a<? if(!$active) {?> href='/main/tnt.php'<? } ?> class='nav-tnt'>Tigernet Talk</a>
	</li>
	<? $active = ereg('clemson_hotline.php', $script); ?>
	<li class='<? if($active) { ?>active<? } ?>'>
		<a<? if(!$active) {?> href='/main/tnt.php'<? } ?> class='nav-hotline'>Clemson Hotline</a>
	</li>
	...
	<li>
		<a href='http://www.apple.com/itunes/whatson/' class='nav-itunes'>Itunes</a>
	</li>
